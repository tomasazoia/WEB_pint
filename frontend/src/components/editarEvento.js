...
const EditarEvento = () => {
    ...
    useEffect(() => {
        const fetchEvento = async () => {
            try {
                const response = await axios.get(`https://pintfinal-backend.onrender.com/evento/get/${id}`);
    ...
    useEffect(() => {
        const fetchSubAreas = async () => {
            if (evento.ID_AREA) {
                try {
                    const response = await axios.get(`https://pintfinal-backend.onrender.com/subarea/list/${evento.ID_AREA}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://pintfinal-backend.onrender.com/evento/update/${id}`, formData, {
                headers: {
