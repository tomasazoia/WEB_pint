...
const LocaisArea = () => {
    const { areaid } = useParams(); // Pega o ID da subárea da URL
    ...
    useEffect(() => {
        const fetchLocais = async () => {
            ...
            try {
                ...
                const response = await axios.get(`http://localhost:3000/locais/area/${areaid}/user/${userId}`);
