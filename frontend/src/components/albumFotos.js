...
const AlbumFotosEvento = () => {
    ...
    useEffect(() => {
        const fetchFotos = async () => {
            ...
            try {
                ...
                const response = await axios.get(`https://pintfinal-backend.onrender.com/album/evento/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('https://pintfinal-backend.onrender.com/album/create', formData, {
                headers: {
    ...
    const handleDelete = async (fotoId) => {
        try {
            await axios.delete(`https://pintfinal-backend.onrender.com/album/delete/${fotoId}`);
                        ...
                        {fotos.map((foto) => (
                            <div className="col-sm-6 col-md-4" key={foto.ID_FOTO}>
                                <div className="position-relative">
                                    <img
                                        src={`https://pintfinal-backend.onrender.com/${foto.foto}`}
                                        alt={foto.LEGENDA}
