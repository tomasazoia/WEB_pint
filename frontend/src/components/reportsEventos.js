...
const ReportsView = () => {
    ...
    const fetchReports = async (userId) => {
        try {
            ...
            const response = await axios.get(`https://pint-backend-5gz8.onrender.com/reporteventos/list`, {
                headers: {
                    'x-auth-token': token,
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await axios.delete(`https://pint-backend-5gz8.onrender.com/reporteventos/delete/${id}`, {
                headers: {
                    'x-auth-token': token,
                },
            });
