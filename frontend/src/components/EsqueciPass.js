...
const EsqueciPass = () => {
  ...
  const handleRequestReset = async () => {
    try {
      await axios.post('https://pint-backend-5gz8.onrender.com/auth/request-password-reset', { user_mail: email });
  ...
  const handleConfirmCode = async () => {
    try {
      await axios.post('https://pint-backend-5gz8.onrender.com/auth/confirm-reset-code', { user_mail: email, resetCode: code });
  ...
  const handleResetPassword = async () => {
    try {
      await axios.post('https://pint-backend-5gz8.onrender.com/auth/reset-password', { user_mail: email, new_password: newPassword });
