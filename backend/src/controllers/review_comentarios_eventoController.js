const ReviewComentariosEvento = require('../models/review_comentarios_evento');
const Comentarios = require('../models/comentarios_evento');
const Users = require('../models/users');

// Criar uma nova review de um comentário
...
exports.getAllReviews = async (req, res) => {
    try {
        const reviews = await ReviewComentariosEvento.findAll();
...
exports.getReviewById = async (req, res) => {
    ...
    try {
        const review = await ReviewComentariosEvento.findByPk(id);
...
// Contar o número de reviews de um comentário
exports.countReviewsByComentario = async (req, res) => {
    const { id } = req.params;
    try {
        const count = await ReviewComentariosEvento.count({ where: { ID_COMENTARIO: id } });
        res.json({ count });
    } catch (error) {
...
// Calcular a média das reviews de um comentário
...
// Listar todas as reviews de um comentário
