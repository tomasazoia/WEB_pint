const ReviewComentariosLocal = require('../models/review_comentarios_local');
const Comentarios = require('../models/comentarios_local');
const Users = require('../models/users');

// Criar uma nova review de um comentário de um local
exports.createReview = async (req, res) => {
    ...
    try {
        ...
        // Criar a review
        const newReview = await ReviewComentariosLocal.create({
            ID_COMENTARIO,
            ID_CRIADOR,
            REVIEW
        });
...
exports.getAllReviews = async (req, res) => {
    try {
        const reviews = await ReviewComentariosLocal.findAll();
...
exports.getReviewById = async (req, res) => {
    ...
    try {
        const review = await ReviewComentariosLocal.findByPk(id);
...
// Contar o número de reviews de um comentário de um local
exports.countReviewsByComentario = async (req, res) => {
    const { id } = req.params;
    try {
        const count = await ReviewComentariosLocal.count({ where: { ID_COMENTARIO: id } });
        res.json({ count });
    } catch (error) {
...
// Calcular a média das reviews de um comentário de um local
...
// Listar todas as reviews de um comentário específico de um local
